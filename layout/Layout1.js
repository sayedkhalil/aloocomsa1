...
<li className="nav-item ">
    <Link href="/aboute">
    <a className="nav-link text-white " >حمل التطبيق</a>
    </Link>
  </li>
  <li className="nav-item ">
    <Link href="/jop">
    <a className="nav-link text-white " >التوظيف</a>
    </Link>
  </li>
  <li className="nav-item ">
    <Link href="/restraunt">
    <a className="nav-link text-white " >سجل كمطعم</a>
    </Link>
  </li>
  <li className="nav-item ">
    <Link href="/captain">
    <a className="nav-link text-white " >سجل كمندوب</a>
    </Link>
  </li>
  <li className="nav-item ">
    <Link href="/aboute">
    <a className="nav-link text-white " >من نحن</a>
    </Link>
  </li>
